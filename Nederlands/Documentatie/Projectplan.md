...
| Methode | Uitvoering | [Onderzoeksvraag](#onderzoeksvragen) |
|:-------:|:----------:|:------------------------------------:|
| Library|||
...
|A/B Testing|Er worden verschillende prototypes gemaakt, om te testen welke layouts/features het beste werken voor de target audience.|2.4|
