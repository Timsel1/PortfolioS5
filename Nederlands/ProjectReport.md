...
Voor meer informatie kan [hier](Documentatie/01.%20Opzet%20van%20het%20Project/Projectplan.md#de-opdracht) in het projectplan worden gekeken.
...
Meer informatie hierover is te vinden in het [projectplan](Documentatie/01.%20Opzet%20van%20het%20Project/Projectplan.md).
...
Voor meer informatie over het ticketsysteem kan [hier](Documentatie/10.%20Project%20Management/TicketSysteem.md) gekeken worden.
...
Voor meer informatie over de Git flow en commits kan [hier](Documentatie/10.%20Project%20Management/GitflowEnCommits.md) worden gekeken.
...
Voor uitgevoerde tests met betrekking tot de frontend kan [hier](Documentatie/04.%20UI%20Validatie) gekeken worden. 
...
Voor meer informatie over de unit tests kan [hier](Documentatie/07.%20Backend%20Validatie/UnitTests.md) worden gekeken.
...
|Document|[Library](https://ictresearchmethods.nl/library/)|[Field](https://ictresearchmethods.nl/Field/)|[Lab](https://ictresearchmethods.nl/Lab/)|[Showroom](https://ictresearchmethods.nl/Showroom/)|[Workshop](https://ictresearchmethods.nl/Workshop/)|
|:------:|:-----:|:---:|:-:|:------:|:------:|
|[Projectplan Uitbreiding Backend](Documentatie/05.%20Opzet%20Backend/ProjectplanUitbreidingBackend.md)|Expert interview|Explore user requirements| | |Requirements prioritization|
|[Design Document](Documentatie/01.%20Opzet%20van%20het%20Project/DesignDocument.md)| | |A/B testing| |IT architecture sketching, Prototyping|
...
|Document|[Library](https://ictresearchmethods.nl/library/)|[Field](https://ictresearchmethods.nl/Field/)|[Lab](https://ictresearchmethods.nl/Lab/)|[Showroom](https://ictresearchmethods.nl/Showroom/)|[Workshop](https://ictresearchmethods.nl/Workshop/)|
|:------:|:-----:|:---:|:-:|:------:|:------:|
|[Gebruiksvriendelijke UI Survey](Documentatie/02.%20UI%20Design/1.%20GebruiksvriendelijkeUISurvey.md)|Expert interview|Survey| | | |
|[Gebruiksvriendelijke UI Wireframe](Documentatie/02.%20UI%20Design/2.%20GebruiksvriendelijkeUIWireframe.md)|Expert interview||||Prototyping|
| [Gebruiksvriendelijke UI Prototype](Documentatie/02.%20UI%20Design/3.%20GebruiksvriendelijkeUIPrototype.md)|Available Product Analysis, Expert interview| | | |Prototyping|
|[Gebruiksvriendelijke UI Usability Test](Documentatie/02.%20UI%20Design/4.%20GebruiksvriendelijkeUIUsabilityTest.md)|Expert interview |Survey|Usability testing |Peer review | |
...
De uitgevoerde onderzoeken hebben ook aanzienlijk bijgedragen aan het succes van het stageproject. De [usability-tests](Documentatie/04.%20UI%20Validatie), specifiek gericht op de geoptimaliseerde gebruikersinterface (UI) voor het Datapanel-configuratieproces, hebben waardevolle inzichten opgeleverd. Door middel van deze tests werd niet alleen de gebruiksvriendelijkheid van de UI geëvalueerd, maar werden ook specifieke knelpunten en verbeterpunten geïdentificeerd.
...
Als bewijs van mijn betrokkenheid bij Analysis kan ik verwijzen naar mijn requirements documenten voor zowel de [frontend](Documentatie/01.%20Opzet%20van%20het%20Project/DesignDocument.md) als de [backend](Documentatie/05.%20Opzet%20Backend/ProjectplanUitbreidingBackend.md) en [de uitgevoerde survey om achter deze requirements te komen](Documentatie/01.%20Opzet%20van%20het%20Project/Kwaliteitseisen.md). De bijbehorende documenten illustreren mijn vermogen om complexe analyses uit te voeren en vereisten helder te definiëren, waarmee ik voldoe aan het niveau dat van een junior bachelor wordt verwacht.

In het design domein heb ik [wireframes](Documentatie/02.%20UI%20Design/2.%20GebruiksvriendelijkeUIWireframe.md) en een [interactief prototype](Documentatie/02.%20UI%20Design/3.%20GebruiksvriendelijkeUIPrototype.md) ontwikkeld, dit proces volgde na de verzameling van alle requirements voor het project. De wireframes dienden als de blauwdruk voor de lay-out en structuur van de gebruikersinterface, terwijl het prototype een interactieve weergave bood.  
Deze producten zijn ontworpen met een iteratief feedbackproces. Door feedback te verzamelen van relevante stakeholders en gebruikers, kon de UI worden verfijnd en aangepast om beter te voldoen aan de behoeften en verwachtingen. Dit zorgde ervoor dat de uiteindelijke gebruikersinterface niet alleen visueel aantrekkelijk was, maar ook functioneel en intuïtief in gebruik.  
Het interactieve prototype is later gebruikt voor een [usability test](Documentatie/02.%20UI%20Design/4.%20GebruiksvriendelijkeUIUsabilityTest.md). Door het prototype te presenteren aan gebruikers en hun interacties ermee te observeren, konden waardevolle inzichten verzameld worden over de gebruiksvriendelijkheid en effectiviteit van de UI. Deze gegevens zijn vervolgens gebruikt om verdere verbeteringen aan te brengen.

Binnen het domein van Realize heb ik gewerkt aan de ontwikkeling van de UI en backend-service, waarbij ik gestandaardiseerde procedures heb gevolgd om efficiëntie en gebruiksvriendelijkheid te waarborgen. Het resultaat van deze inspanningen, gedocumenteerd in mijn [documentatie directory](documentatie), weerspiegelt de professionele producten die ik heb voortgebracht. In deze directory kan er gekeken worden bij [UI realisatie](Documentatie/03.%20UI%20Realisatie) en [backend realisatie](Documentatie/06.%20Backend%20Realisatie)  
De source code kan bij dit leerdoel ook dienen als een professional product, de door mij gemaakte source code staat niet in dit publieke repository, maar is wel ingeleverd bij de onderwijsinstelling.

Mijn rol in Advise komt tot uiting in het kopje [conclusie en aanbevelingen](#conclusie-en-aanbevelingen), waar ik advies geef over de volgende stappen die genomen kunnen worden binnen dit project, met de belangrijkste features, gesorteerd op relevantie.

Binnen Manage & Control heb ik actief deelgenomen aan projectmanagement activiteiten, zoals het [gebruik van Gitflow](Documentatie/10.%20Project%20Management) en het bijhouden van voortgang in het [ticketsysteem](Documentatie/10.%20Project%20Management/TicketSysteem.md). Deze praktijken zijn getuigen van mijn vermogen om bij te dragen aan het beheer en de controle van het project op een niveau dat in lijn is met mijn junior bachelorniveau.
...
Daarnaast integreerde ik mijn werkzaamheden naadloos in het [ticketsysteem](Documentatie/10.%20Project%20Management/TicketSysteem.md) van het bedrijf. Elk aspect van het project werd verwerkt naar kleine taken, die vervolgens werden gevolgd en bijgewerkt via het ticketsysteem. Deze benadering zorgde niet alleen voor een gestructureerde uitvoering van het project, maar bood ook transparantie over de voortgang.
...
De resultaten van mijn werk waren overduidelijk relevant voor verschillende belanghebbenden. Mijn inspanningen waren gericht op het verwerken van de behoeften van de stakeholders, waardoor mijn werk bijdroeg aan zinvolle oplossingen en waarde toevoegde aan het bedrijfskader, zoals te zien in mijn [TICT pdf onder het kopje stakeholders](Documentatie/11.%20Technology%20Impact%20Cycle%20Tool/TICT.pdf) en het [requirements document](Documentatie/01.%20Opzet%20van%20het%20Project/RequirementsDocument.md#project-overview), waarin ik mijn stakeholders beschrijf.
...
Om dit leerdoel aan te tonen, heb ik mijn aanpak gericht op het begrijpen van de behoeften van de klant en ervoor gezorgd dat mijn voorgestelde oplossing niet alleen technisch geschikt was, maar ook voldeed aan zakelijke, ethische en onderhoudscriteria. Dit omvatte het gebruik van normen en methoden/tools, zoals [TICT](Documentatie/11.%20Technology%20Impact%20Cycle%20Tool/TICT.pdf), om bij mijn beoordelingsproces rekening te houden met de zakelijke, ethische en onderhoudscriteria.

Daarnaast heb ik mijn vermogen aangetoond om de uitvoering van het project effectief te beheren. Dit omvatte het opstellen van een gedetailleerd [projectplan](Documentatie/01.%20Opzet%20van%20het%20Project/Projectplan.md), waarbij ik aandacht besteedde aan onderzoeken, tijdsplanning, budget, risicobeheer en de kwaliteit van de oplossing. Hierdoor kon ik aantonen dat ik niet alleen technisch competent ben, maar ook in staat ben om het grotere plaatje te bekijken, waarbij ik zakelijke en ethische overwegingen integreer in het gehele projectproces.

Hoe ik de management van dit project heb aangepakt staat eerder beschreven in dit document bij [aanpak](#aanpak). De bijbehorende producten voor dit deel van dit leerdoel zijn: [ticketsysteem](Documentatie/10.%20Project%20Management/TicketSysteem.md) en [gitflow en commits](Documentatie/10.%20Project%20Management/GitflowEnCommits.md).
...
Mijn ondernemerschap en persoonlijke ontwikkeling tijdens deze stage, komt tot uiting in mijn [aanpak](#aanpak). Ik neem zowel op het gebied van planning als inhoud de leiding in mijn project, waarbij ik initiatief toon en verantwoordelijkheid neem voor het succesvol verloop ervan.
